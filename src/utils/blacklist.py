"""
This module contains a set of blacklisted domains (ALL_BLACKLISTED_DOMAINS).

The list is used to detect temporary or suspicious email addresses
that are often associated with spam, fraud, or other unwanted activities.
Checking an email address against this list helps prevent the use of
unreliable domains in the system.
"""

ALL_BLACKLISTED_DOMAINS: set[str] = {
    "0-mail.com",
    "027168.com",
    "0815.ru",
    "0815.ry",
